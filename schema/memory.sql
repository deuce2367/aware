...
CREATE TABLE memory (
  ...
  used smallint(5) unsigned default NULL,
  free smallint(5) unsigned default NULL,
  cached smallint(5) unsigned default NULL,
  buffers smallint(5) unsigned default NULL,
  usedSwap smallint(5) unsigned default NULL,
  freeSwap smallint(5) unsigned default NULL,
